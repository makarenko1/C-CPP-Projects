...
public:
	 ...
	 * @return true for success, false otherwise //TODO: ask why void then
	 */
     ...
     * @return
     */
    rank_map &get_ranks(); //TODO: ask which getter
	 ...
	 */
    friend std::ostream& operator<< (std::ostream& os, const RSUser &other);

 private:
  const std::string &_username;
  rank_map _ranks;
  RecommenderSystem &_recommender_system;
};
